...
function finder(providedArray) {
  for (var i = 0; i < providedArray.length; i++)
    if (providedArray[i] === getRandomArbitrary()) {
      return true;
    }
  return false;
}
...
//Code Here
function employeeList(devMountainEmployees, name) {
...
employeeList(devMountainEmployees, "Cahlan");
